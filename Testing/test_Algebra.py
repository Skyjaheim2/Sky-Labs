            ...
            },
            {
                ...
                'expected_val': {'steps': [
                    {'type': 'e-step', 'heading': '\\displaystyle e^{2x+x}=\\frac{e^{3x}}{1}', 'e-steps': [
                        {'type': 'main-step', 'description': '\\displaystyle \\text{Add Like Terms Left to Right}', 'info': '\\displaystyle 2x+x=3x'},
                        {'type': 'main-step', 'description': '\\displaystyle \\text{Simplify Exponent}', 'info': '\\displaystyle e^{2x+x}=e^{3x}'}]},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Adjust fractions based on their LCM of }\\left(t+1\\right)', 'info': '\\displaystyle \\frac{e^{3x}}{1}+\\frac{s}{t+1}=\\frac{e^{3x}\\cdot\\left(t+1\\right)}{\\left(t+1\\right)}+\\frac{s}{\\left(t+1\\right)}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Apply The Fraction Rule:}\\ \\frac{a}{c}\\pm\\frac{b}{c}=\\frac{a \\pm b}{c}', 'info': '\\displaystyle \\frac{e^{3x}\\cdot\\left(t+1\\right)}{\\left(t+1\\right)}+\\frac{s}{\\left(t+1\\right)}=\\frac{e^{3x}\\cdot\\left(t+1\\right)+s}{\\left(t+1\\right)}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Combine Results}', 'info': '\\displaystyle \\frac{e^{3x}\\cdot\\left(t+1\\right)+s}{\\left(t+1\\right)}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Distribute Parentheses}', 'info': '\\displaystyle e^{3x}\\cdot\\left(t+1\\right)=e^{3x}\\cdot t+e^{3x}\\cdot1'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle e^{3x}\\cdot t=e^{3x}t'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle e^{3x}\\cdot1=e^{3x}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Group Terms}', 'info': '\\displaystyle \\displaystyle e^{3x}t+e^{3x}=e^{3x}+e^{3x}t'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Simplify Numerator}', 'info': '\\displaystyle \\frac{e^{3x}\\cdot\\left(t+1\\right)+s}{\\left(t+1\\right)}=\\frac{e^{3x}+e^{3x}t+s}{\\left(t+1\\right)}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Remove Redundant Parentheses}', 'info': '\\displaystyle \\left(t+1\\right)=t+1'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Simplify Denominator}', 'info': '\\displaystyle \\frac{e^{3x}+e^{3x}t+s}{\\left(t+1\\right)}=\\frac{e^{3x}+e^{3x}t+s}{t+1}'}], 'finalResult': '\\frac{e^{3x}+e^{3x}t+s}{t+1}'},
            },
            {
                'expression': '20^{1+1}',
                'keyword': None,
        ...
        expressionsAndExpectedVal = [
            ...
            },
            {
                ...
                'expected_val': {'steps': [
                    ...
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Adjust fractions based on their LCM of }abc', 'info': '\\displaystyle \\frac{14}{a}+\\frac{-2}{b}+\\frac{11}{c}=\\frac{14\\cdot bc}{abc}+\\frac{-2\\cdot ac}{abc}+\\frac{11\\cdot ab}{abc}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Apply The Fraction Rule:}\\ \\frac{a}{c}\\pm\\frac{b}{c}=\\frac{a \\pm b}{c}', 'info': '\\displaystyle \\frac{14\\cdot bc}{abc}+\\frac{-2\\cdot ac}{abc}+\\frac{11\\cdot ab}{abc}=\\frac{14\\cdot bc+-2\\cdot ac+11\\cdot ab}{abc}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Combine Results}', 'info': '\\displaystyle \\frac{14\\cdot bc-2\\cdot ac+11\\cdot ab}{abc}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle 14\\cdot bc=14bc'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle 2\\cdot ac=2ac'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle 11\\cdot ab=11ab'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Simplify Numerator}', 'info': '\\displaystyle \\frac{14\\cdot bc-2\\cdot ac+11\\cdot ab}{abc}=\\frac{14bc-2ac+11ab}{abc}'}], 'finalResult': '\\frac{14bc-2ac+11ab}{abc}'},
            },
            # TODO
            {
            ...
            },
            {
                ...
                'expected_val': {'steps': [
                    ...
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Adjust fractions based on their LCM of }\\left(x+y\\right)\\left(u+v\\right)', 'info': '\\displaystyle \\frac{4x^{2}}{x+y}-\\frac{15x^{2}}{u+v}=\\frac{4x^{2}\\cdot\\left(u+v\\right)}{\\left(x+y\\right)\\left(u+v\\right)}-\\frac{15x^{2}\\cdot\\left(x+y\\right)}{\\left(x+y\\right)\\left(u+v\\right)}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Apply The Fraction Rule:}\\ \\frac{a}{c}\\pm\\frac{b}{c}=\\frac{a \\pm b}{c}', 'info': '\\displaystyle \\frac{4x^{2}\\cdot\\left(u+v\\right)}{\\left(x+y\\right)\\left(u+v\\right)}-\\frac{15x^{2}\\cdot\\left(x+y\\right)}{\\left(x+y\\right)\\left(u+v\\right)}=\\frac{4x^{2}\\cdot\\left(u+v\\right)-15x^{2}\\cdot\\left(x+y\\right)}{\\left(x+y\\right)\\left(u+v\\right)}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Combine Results}', 'info': '\\displaystyle \\frac{4x^{2}\\cdot\\left(u+v\\right)-15x^{2}\\cdot\\left(x+y\\right)}{\\left(x+y\\right)\\left(u+v\\right)}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Distribute Parentheses}', 'info': '\\displaystyle 4x^{2}\\cdot\\left(u+v\\right)=4x^{2}\\cdot u+4x^{2}\\cdot v'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle 4x^{2}\\cdot u=4x^{2}u'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle 4x^{2}\\cdot v=4x^{2}v'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Distribute Parentheses}', 'info': '\\displaystyle -15x^{2}\\cdot\\left(x+y\\right)=-15x^{2}\\cdot x+-15x^{2}\\cdot y'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle 15x^{2}\\cdot x=15x^{2+1}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle 15x^{2}\\cdot y=15x^{2}y'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Add Numbers Left to Right}', 'info': '\\displaystyle 2+1=3'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Simplify Exponent}', 'info': '\\displaystyle -15x^{2+1}=-15x^{3}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Group Terms}', 'info': '\\displaystyle \\displaystyle 4x^{2}u+4x^{2}v-15x^{3}-15x^{2}y=-15x^{3}+4x^{2}u+4x^{2}v-15x^{2}y'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Simplify Numerator}', 'info': '\\displaystyle \\frac{4x^{2}\\cdot\\left(u+v\\right)-15x^{2}\\cdot\\left(x+y\\right)}{\\left(x+y\\right)\\left(u+v\\right)}=\\frac{-15x^{3}+4x^{2}u+4x^{2}v-15x^{2}y}{\\left(x+y\\right)\\left(u+v\\right)}'}], 'finalResult': '\\frac{-15x^{3}+4x^{2}u+4x^{2}v-15x^{2}y}{\\left(x+y\\right)\\left(u+v\\right)}'},
            },
            # TODO
            {
                ...
                'keyword': 'combine',
                'expected_val': {'steps': [
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Adjust fractions based on their LCM of }x\\left(x+1\\right)\\left(x+y+z\\right)', 'info': '\\displaystyle \\frac{10y}{x}+\\frac{3x}{x+1}+\\frac{2}{x+y+z}=\\frac{10y\\cdot\\left(x+1\\right)\\left(x+y+z\\right)}{x\\left(x+1\\right)\\left(x+y+z\\right)}+\\frac{3x\\cdot x\\left(x+y+z\\right)}{x\\left(x+1\\right)\\left(x+y+z\\right)}+\\frac{2\\cdot x\\left(x+1\\right)}{x\\left(x+1\\right)\\left(x+y+z\\right)}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Apply The Fraction Rule:}\\ \\frac{a}{c}\\pm\\frac{b}{c}=\\frac{a \\pm b}{c}', 'info': '\\displaystyle \\frac{10y\\cdot\\left(x+1\\right)\\left(x+y+z\\right)}{x\\left(x+1\\right)\\left(x+y+z\\right)}+\\frac{3x\\cdot x\\left(x+y+z\\right)}{x\\left(x+1\\right)\\left(x+y+z\\right)}+\\frac{2\\cdot x\\left(x+1\\right)}{x\\left(x+1\\right)\\left(x+y+z\\right)}=\\frac{10y\\cdot\\left(x+1\\right)\\left(x+y+z\\right)+3x\\cdot x\\left(x+y+z\\right)+2\\cdot x\\left(x+1\\right)}{x\\left(x+1\\right)\\left(x+y+z\\right)}'}], 'finalResult': '\\frac{10y\\cdot\\left(x+1\\right)\\left(x+y+z\\right)+3x\\cdot x\\left(x+y+z\\right)+2\\cdot x\\left(x+1\\right)}{x\\left(x+1\\right)\\left(x+y+z\\right)}'},
            },
            {
                ...
                'expected_val': {'steps': [
                    ...
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Adjust fractions based on their LCM of }\\left(\\sqrt{13x+y}+1\\right)\\left(e^{5x}+\\sqrt{5x}\\right)', 'info': '\\displaystyle \\frac{7x^{2}+4}{\\sqrt{13x+y}+1}+\\frac{36x}{e^{5x}+\\sqrt{5x}}=\\frac{\\left(7x^{2}+4\\right)\\cdot\\left(e^{5x}+\\sqrt{5x}\\right)}{\\left(\\sqrt{13x+y}+1\\right)\\left(e^{5x}+\\sqrt{5x}\\right)}+\\frac{36x\\cdot\\left(\\sqrt{13x+y}+1\\right)}{\\left(\\sqrt{13x+y}+1\\right)\\left(e^{5x}+\\sqrt{5x}\\right)}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Apply The Fraction Rule:}\\ \\frac{a}{c}\\pm\\frac{b}{c}=\\frac{a \\pm b}{c}', 'info': '\\displaystyle \\frac{\\left(7x^{2}+4\\right)\\cdot\\left(e^{5x}+\\sqrt{5x}\\right)}{\\left(\\sqrt{13x+y}+1\\right)\\left(e^{5x}+\\sqrt{5x}\\right)}+\\frac{36x\\cdot\\left(\\sqrt{13x+y}+1\\right)}{\\left(\\sqrt{13x+y}+1\\right)\\left(e^{5x}+\\sqrt{5x}\\right)}=\\frac{\\left(7x^{2}+4\\right)\\cdot\\left(e^{5x}+\\sqrt{5x}\\right)+36x\\cdot\\left(\\sqrt{13x+y}+1\\right)}{\\left(\\sqrt{13x+y}+1\\right)\\left(e^{5x}+\\sqrt{5x}\\right)}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Combine Results}', 'info': '\\displaystyle \\frac{\\left(7x^{2}+4\\right)\\cdot\\left(e^{5x}+\\sqrt{5x}\\right)+36x\\cdot\\left(\\sqrt{13x+y}+1\\right)}{\\left(\\sqrt{13x+y}+1\\right)\\left(e^{5x}+\\sqrt{5x}\\right)}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Apply FOIL Method}: \\\\ (a+b)(c+d)=ac+ad+bc+bd', 'info': '\\displaystyle \\left(7x^{2}+4\\right)\\left(e^{5x}+\\sqrt{5x}\\right)=7x^{2}\\cdot e^{5x}+7x^{2}\\cdot\\sqrt{5x}+4\\cdot e^{5x}+4\\cdot\\sqrt{5x}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle 7x^{2}\\cdot e^{5x}=7x^{2}e^{5x}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle 7x^{2}\\cdot\\sqrt{5x}=7x^{2}\\sqrt{5x}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle 4\\cdot e^{5x}=4e^{5x}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle 4\\cdot\\sqrt{5x}=4\\sqrt{5x}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Group Terms}', 'info': '\\displaystyle \\displaystyle 7x^{2}e^{5x}+7x^{2}\\sqrt{5x}+4e^{5x}+4\\sqrt{5x}=4e^{5x}+4\\sqrt{5x}+7x^{2}e^{5x}+7x^{2}\\sqrt{5x}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Combine Results}', 'info': '\\displaystyle 7x^{2}\\cdot e^{5x}+7x^{2}\\cdot\\sqrt{5x}+4\\cdot e^{5x}+4\\cdot\\sqrt{5x}=4e^{5x}+4\\sqrt{5x}+7x^{2}e^{5x}+7x^{2}\\sqrt{5x}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Distribute Parentheses}', 'info': '\\displaystyle 36x\\cdot\\left(\\sqrt{13x+y}+1\\right)=36x\\cdot\\sqrt{13x+y}+36x\\cdot1'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle 36x\\cdot\\sqrt{13x+y}=36x\\sqrt{13x+y}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle 36x\\cdot1=36x'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Simplify Numerator}', 'info': '\\displaystyle \\frac{\\left(7x^{2}+4\\right)\\cdot\\left(e^{5x}+\\sqrt{5x}\\right)+36x\\cdot\\left(\\sqrt{13x+y}+1\\right)}{\\left(\\sqrt{13x+y}+1\\right)\\left(e^{5x}+\\sqrt{5x}\\right)}=\\frac{4e^{5x}+4\\sqrt{5x}+7x^{2}e^{5x}+7x^{2}\\sqrt{5x}+36x\\sqrt{13x+y}+36x}{\\left(\\sqrt{13x+y}+1\\right)\\left(e^{5x}+\\sqrt{5x}\\right)}'}], 'finalResult': '\\frac{4e^{5x}+4\\sqrt{5x}+7x^{2}e^{5x}+7x^{2}\\sqrt{5x}+36x\\sqrt{13x+y}+36x}{\\left(\\sqrt{13x+y}+1\\right)\\left(e^{5x}+\\sqrt{5x}\\right)}'},
            },
            {
                'expression': 'frac{x}{y}+frac{u}{v}+2',
                'keyword': 'combine',
                'expected_val': {'steps': [
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Adjust fractions based on their LCM of }yv', 'info': '\\displaystyle \\frac{x}{y}+\\frac{u}{v}+2=\\frac{x\\cdot v}{yv}+\\frac{u\\cdot y}{yv}+\\frac{2\\cdot yv}{yv}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Apply The Fraction Rule:}\\ \\frac{a}{c}\\pm\\frac{b}{c}=\\frac{a \\pm b}{c}', 'info': '\\displaystyle \\frac{x\\cdot v}{yv}+\\frac{u\\cdot y}{yv}+\\frac{2\\cdot yv}{yv}=\\frac{x\\cdot v+u\\cdot y+2\\cdot yv}{yv}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Combine Results}', 'info': '\\displaystyle \\frac{x\\cdot v+u\\cdot y+2\\cdot yv}{yv}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle x\\cdot v=xv'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle u\\cdot y=uy'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle 2\\cdot yv=2yv'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Simplify Numerator}', 'info': '\\displaystyle \\frac{x\\cdot v+u\\cdot y+2\\cdot yv}{yv}=\\frac{xv+uy+2yv}{yv}'}], 'finalResult': '\\frac{xv+uy+2yv}{yv}'},
            },
            {
                ...
                'expected_val': {'steps': [
                    ...
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Adjust fractions based on their LCM of }yv', 'info': '\\displaystyle \\frac{x}{y}+\\frac{u}{v}+\\frac{s}{1}=\\frac{x\\cdot v}{yv}+\\frac{u\\cdot y}{yv}+\\frac{s\\cdot yv}{yv}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Apply The Fraction Rule:}\\ \\frac{a}{c}\\pm\\frac{b}{c}=\\frac{a \\pm b}{c}', 'info': '\\displaystyle \\frac{x\\cdot v}{yv}+\\frac{u\\cdot y}{yv}+\\frac{s\\cdot yv}{yv}=\\frac{x\\cdot v+u\\cdot y+s\\cdot yv}{yv}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Combine Results}', 'info': '\\displaystyle \\frac{x\\cdot v+u\\cdot y+s\\cdot yv}{yv}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle x\\cdot v=xv'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle u\\cdot y=uy'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle s\\cdot yv=syv'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Simplify Numerator}', 'info': '\\displaystyle \\frac{x\\cdot v+u\\cdot y+s\\cdot yv}{yv}=\\frac{xv+uy+syv}{yv}'}], 'finalResult': '\\frac{xv+uy+syv}{yv}'},
            },
            {
                ...
                'expected_val': {'steps': [{'type': 'e-step', 'heading': '\\displaystyle \\frac{10}{2}=5', 'e-steps': [
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Divide The Numbers}', 'info': '\\displaystyle \\frac{10}{2}=5'}]},
                                           {'type': 'main-step', 'description': '\\displaystyle \\text{Adjust fractions based on their LCM of }t', 'info': '\\displaystyle 5+\\frac{s}{t}=\\frac{5\\cdot t}{t}+\\frac{s}{t}'},
                                           {'type': 'main-step', 'description': '\\displaystyle \\text{Apply The Fraction Rule:}\\ \\frac{a}{c}\\pm\\frac{b}{c}=\\frac{a \\pm b}{c}', 'info': '\\displaystyle \\frac{5\\cdot t}{t}+\\frac{s}{t}=\\frac{5\\cdot t+s}{t}'},
                                           {'type': 'main-step', 'description': '\\displaystyle \\text{Combine Results}', 'info': '\\displaystyle \\frac{5\\cdot t+s}{t}'},
                                           {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle 5\\cdot t=5t'},
                                           {'type': 'main-step', 'description': '\\displaystyle \\text{Simplify Numerator}', 'info': '\\displaystyle \\frac{5\\cdot t+s}{t}=\\frac{5t+s}{t}'}], 'finalResult': '\\frac{5t+s}{t}'},
            },
            {
                ...
                'expected_val': {'steps': [
                    ...
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Adjust fractions based on their LCM of }t', 'info': '\\displaystyle \\frac{10x}{1}+\\frac{s}{t}=\\frac{10x\\cdot t}{t}+\\frac{s}{t}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Apply The Fraction Rule:}\\ \\frac{a}{c}\\pm\\frac{b}{c}=\\frac{a \\pm b}{c}', 'info': '\\displaystyle \\frac{10x\\cdot t}{t}+\\frac{s}{t}=\\frac{10x\\cdot t+s}{t}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Combine Results}', 'info': '\\displaystyle \\frac{10x\\cdot t+s}{t}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle 10x\\cdot t=10xt'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Simplify Numerator}', 'info': '\\displaystyle \\frac{10x\\cdot t+s}{t}=\\frac{10xt+s}{t}'}], 'finalResult': '\\frac{10xt+s}{t}'},
            },
            ...
            },
            {
                ...
                'keyword': 'combine',
                'expected_val': {'steps': [
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Adjust fractions based on their LCM of }\\sqrt{n^{3}+5n^{2}+1}\\sqrt{n}', 'info': '\\displaystyle \\frac{n}{\\sqrt{n}}-\\frac{5n+1}{\\sqrt{n^{3}+5n^{2}+1}}=\\frac{n\\cdot\\sqrt{n^{3}+5n^{2}+1}}{\\sqrt{n^{3}+5n^{2}+1}\\sqrt{n}}-\\frac{\\left(5n+1\\right)\\cdot\\sqrt{n}}{\\sqrt{n^{3}+5n^{2}+1}\\sqrt{n}}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Apply The Fraction Rule:}\\ \\frac{a}{c}\\pm\\frac{b}{c}=\\frac{a \\pm b}{c}', 'info': '\\displaystyle \\frac{n\\cdot\\sqrt{n^{3}+5n^{2}+1}}{\\sqrt{n^{3}+5n^{2}+1}\\sqrt{n}}-\\frac{\\left(5n+1\\right)\\cdot\\sqrt{n}}{\\sqrt{n^{3}+5n^{2}+1}\\sqrt{n}}=\\frac{-\\left(5n+1\\right)\\cdot\\sqrt{n}+n\\cdot\\sqrt{n^{3}+5n^{2}+1}}{\\sqrt{n^{3}+5n^{2}+1}\\sqrt{n}}'}], 'finalResult': '\\frac{-\\left(5n+1\\right)\\cdot\\sqrt{n}+n\\cdot\\sqrt{n^{3}+5n^{2}+1}}{\\sqrt{n^{3}+5n^{2}+1}\\sqrt{n}}'},
            },
            {
                'expression': 'frac{1}{x}+frac{2}{x^{2}}+frac{3}{x^{3}}',
                'keyword': 'combine',
                'expected_val': {'steps': [
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Adjust fractions based on their LCM of }x^{3}', 'info': '\\displaystyle \\frac{1}{x}+\\frac{2}{x^{2}}+\\frac{3}{x^{3}}=\\frac{x^{2}}{x^{3}}+\\frac{2\\cdot x}{x^{3}}+\\frac{3}{x^{3}}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Apply The Fraction Rule:}\\ \\frac{a}{c}\\pm\\frac{b}{c}=\\frac{a \\pm b}{c}', 'info': '\\displaystyle \\frac{x^{2}}{x^{3}}+\\frac{2\\cdot x}{x^{3}}+\\frac{3}{x^{3}}=\\frac{x^{2}+2\\cdot x+3}{x^{3}}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Combine Results}', 'info': '\\displaystyle \\frac{x^{2}+2\\cdot x+3}{x^{3}}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle 2\\cdot x=2x'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Simplify Numerator}', 'info': '\\displaystyle \\frac{x^{2}+2\\cdot x+3}{x^{3}}=\\frac{x^{2}+2x+3}{x^{3}}'}], 'finalResult': '\\frac{x^{2}+2x+3}{x^{3}}'},
            },
            {
                'expression': 'frac{1}{x+1}+frac{2}{(x+1)^{2}}+frac{3}{(x+1)^{3}}',
                'keyword': 'combine',
                'expected_val': {'steps': [
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Adjust fractions based on their LCM of }\\left(x+1\\right)^{3}', 'info': '\\displaystyle \\frac{1}{x+1}+\\frac{2}{\\left(x+1\\right)^{2}}+\\frac{3}{\\left(x+1\\right)^{3}}=\\frac{\\left(x+1\\right)^{2}}{\\left(x+1\\right)^{3}}+\\frac{2\\cdot\\left(x+1\\right)}{\\left(x+1\\right)^{3}}+\\frac{3}{\\left(x+1\\right)^{3}}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Apply The Fraction Rule:}\\ \\frac{a}{c}\\pm\\frac{b}{c}=\\frac{a \\pm b}{c}', 'info': '\\displaystyle \\frac{\\left(x+1\\right)^{2}}{\\left(x+1\\right)^{3}}+\\frac{2\\cdot\\left(x+1\\right)}{\\left(x+1\\right)^{3}}+\\frac{3}{\\left(x+1\\right)^{3}}=\\frac{\\left(x+1\\right)^{2}+2\\cdot\\left(x+1\\right)+3}{\\left(x+1\\right)^{3}}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Combine Results}', 'info': '\\displaystyle \\frac{\\left(x+1\\right)^{2}+2\\cdot\\left(x+1\\right)+3}{\\left(x+1\\right)^{3}}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Distribute Parentheses}', 'info': '\\displaystyle 2\\cdot\\left(x+1\\right)=2\\cdot x+2\\cdot1'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle 2\\cdot x=2x'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle 2\\cdot1=2'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Add Numbers Left to Right}', 'info': '\\displaystyle 2x+2+3=2x+5'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Simplify Numerator}', 'info': '\\displaystyle \\frac{\\left(x+1\\right)^{2}+2\\cdot\\left(x+1\\right)+3}{\\left(x+1\\right)^{3}}=\\frac{\\left(x+1\\right)^{2}+2x+5}{\\left(x+1\\right)^{3}}'}], 'finalResult': '\\frac{\\left(x+1\\right)^{2}+2x+5}{\\left(x+1\\right)^{3}}'},
            },
            {
                'expression': 'frac{1}{x+1}+frac{2}{(x+1)^{2}}+frac{3}{(x+1)^{n}}',
                'keyword': 'combine',
                'expected_val': {'steps': [
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Adjust fractions based on their LCM of }\\left(x+1\\right)^{2}', 'info': '\\displaystyle \\frac{1}{x+1}+\\frac{2}{\\left(x+1\\right)^{2}}+\\frac{3}{\\left(x+1\\right)^{n}}=\\frac{x+1}{\\left(x+1\\right)^{2}}+\\frac{2}{\\left(x+1\\right)^{2}}+\\frac{3\\cdot\\left(x+1\\right)^{-n+2}}{\\left(x+1\\right)^{2}}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Apply The Fraction Rule:}\\ \\frac{a}{c}\\pm\\frac{b}{c}=\\frac{a \\pm b}{c}', 'info': '\\displaystyle \\frac{x+1}{\\left(x+1\\right)^{2}}+\\frac{2}{\\left(x+1\\right)^{2}}+\\frac{3\\cdot\\left(x+1\\right)^{-n+2}}{\\left(x+1\\right)^{2}}=\\frac{3\\cdot\\left(x+1\\right)^{-n+2}+x+1+2}{\\left(x+1\\right)^{2}}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Combine Results}', 'info': '\\displaystyle \\frac{3\\cdot\\left(x+1\\right)^{-n+2}+x+1+2}{\\left(x+1\\right)^{2}}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Simplify Base}', 'info': '\\displaystyle 3\\cdot\\left(x+1\\right)^{-n+2}=3\\left(x+1\\right)^{-n+2}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Add Numbers Left to Right}', 'info': '\\displaystyle x+1+2=x+3'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Simplify Numerator}', 'info': '\\displaystyle \\frac{3\\cdot\\left(x+1\\right)^{-n+2}+x+1+2}{\\left(x+1\\right)^{2}}=\\frac{3\\left(x+1\\right)^{-n+2}+x+3}{\\left(x+1\\right)^{2}}'}], 'finalResult': '\\frac{3\\left(x+1\\right)^{-n+2}+x+3}{\\left(x+1\\right)^{2}}'},
            },
            {
            ...
            },
            {
                ...
                'keyword': 'combine',
                'expected_val': {'steps': [
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Adjust fractions based on their LCM of }3x', 'info': '\\displaystyle \\frac{y}{3}+\\frac{1}{x}=\\frac{y\\cdot x}{3x}+\\frac{3}{3x}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Apply The Fraction Rule:}\\ \\frac{a}{c}\\pm\\frac{b}{c}=\\frac{a \\pm b}{c}', 'info': '\\displaystyle \\frac{y\\cdot x}{3x}+\\frac{3}{3x}=\\frac{y\\cdot x+3}{3x}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Combine Results}', 'info': '\\displaystyle \\frac{y\\cdot x+3}{3x}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle y\\cdot x=yx'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Simplify Numerator}', 'info': '\\displaystyle \\frac{y\\cdot x+3}{3x}=\\frac{yx+3}{3x}'}], 'finalResult': '\\frac{yx+3}{3x}'},
            },
            {
                ...
                'expected_val': {'steps': [
                    ...
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Adjust fractions based on their LCM of }\\left(x+1\\right)\\left(y+1\\right)', 'info': '\\displaystyle \\frac{5x^{3}+6}{x+1}+\\frac{5x^{2}y+5y+3}{y+1}=\\frac{\\left(5x^{3}+6\\right)\\cdot\\left(y+1\\right)}{\\left(x+1\\right)\\left(y+1\\right)}+\\frac{\\left(5x^{2}y+5y+3\\right)\\cdot\\left(x+1\\right)}{\\left(x+1\\right)\\left(y+1\\right)}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Apply The Fraction Rule:}\\ \\frac{a}{c}\\pm\\frac{b}{c}=\\frac{a \\pm b}{c}', 'info': '\\displaystyle \\frac{\\left(5x^{3}+6\\right)\\cdot\\left(y+1\\right)}{\\left(x+1\\right)\\left(y+1\\right)}+\\frac{\\left(5x^{2}y+5y+3\\right)\\cdot\\left(x+1\\right)}{\\left(x+1\\right)\\left(y+1\\right)}=\\frac{\\left(5x^{3}+6\\right)\\cdot\\left(y+1\\right)+\\left(5x^{2}y+5y+3\\right)\\cdot\\left(x+1\\right)}{\\left(x+1\\right)\\left(y+1\\right)}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Combine Results}', 'info': '\\displaystyle \\frac{\\left(5x^{3}+6\\right)\\cdot\\left(y+1\\right)+\\left(5x^{2}y+5y+3\\right)\\cdot\\left(x+1\\right)}{\\left(x+1\\right)\\left(y+1\\right)}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Apply FOIL Method}: \\\\ (a+b)(c+d)=ac+ad+bc+bd', 'info': '\\displaystyle \\left(5x^{3}+6\\right)\\left(y+1\\right)=5x^{3}\\cdot y+5x^{3}\\cdot1+6\\cdot y+6\\cdot1'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle 5x^{3}\\cdot y=5x^{3}y'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle 5x^{3}\\cdot1=5x^{3}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle 6\\cdot y=6y'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle 6\\cdot1=6'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Group Terms}', 'info': '\\displaystyle \\displaystyle 5x^{3}y+5x^{3}+6y+6=5x^{3}+5x^{3}y+6y+6'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Combine Results}', 'info': '\\displaystyle 5x^{3}\\cdot y+5x^{3}\\cdot1+6\\cdot y+6\\cdot1=5x^{3}+5x^{3}y+6y+6'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Distribute Parentheses}', 'info': '\\displaystyle \\left(5x^{2}y+5y+3\\right)\\left(x+1\\right)=5x^{2}y\\cdot x+5x^{2}y\\cdot1+5y\\cdot x+5y\\cdot1+3\\cdot x+3\\cdot1'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle 5x^{2}y\\cdot x=5x^{1+2}y'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle 5x^{2}y\\cdot1=5x^{2}y'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle 5y\\cdot x=5yx'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle 5y\\cdot1=5y'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle 3\\cdot x=3x'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle 3\\cdot1=3'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Add Numbers Left to Right}', 'info': '\\displaystyle 1+2=3'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Simplify Exponent}', 'info': '\\displaystyle 5x^{1+2}=5x^{3}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Combine Results}', 'info': '\\displaystyle 5x^{2}y\\cdot x+5x^{2}y\\cdot1+5y\\cdot x+5y\\cdot1+3\\cdot x+3\\cdot1=5x^{3}y+5x^{2}y+5yx+5y+3x+3'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Group Like Terms}', 'info': '\\displaystyle 5x^{3}y+6y+6+5x^{3}y+5x^{2}y+5yx+5y+3x+3=5x^{3}y+5x^{3}y+6y+5y+5x^{2}y+5yx+3x+6+3'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Add Like Terms Left to Right}', 'info': '\\displaystyle 5x^{3}y+5x^{3}y+6y+5y+5x^{2}y+5yx+3x+6+3=10x^{3}y+11y+5x^{2}y+5yx+3x+6+3'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Add Numbers Left to Right}', 'info': '\\displaystyle 10x^{3}y+11y+5x^{2}y+5yx+3x+6+3=10x^{3}y+11y+5x^{2}y+5yx+3x+9'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Simplify Numerator}', 'info': '\\displaystyle \\frac{\\left(5x^{3}+6\\right)\\cdot\\left(y+1\\right)+\\left(5x^{2}y+5y+3\\right)\\cdot\\left(x+1\\right)}{\\left(x+1\\right)\\left(y+1\\right)}=\\frac{5x^{3}+10x^{3}y+11y+5x^{2}y+5yx+3x+9}{\\left(x+1\\right)\\left(y+1\\right)}'}], 'finalResult': '\\frac{5x^{3}+10x^{3}y+11y+5x^{2}y+5yx+3x+9}{\\left(x+1\\right)\\left(y+1\\right)}'}
            },
            {
...

            {
                ...
                'expected_val': {'steps': [
                    ...
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Adjust fractions based on their LCM of }\\left(e^{9x}+\\sqrt{6e^{2x}}+3x\\right)\\left(23\\sqrt{x}+4\\right)', 'info': '\\displaystyle \\frac{6x+1}{e^{9x}+\\sqrt{6e^{2x}}+3x}+\\frac{49x^{2}+6}{23\\sqrt{x}+4}=\\frac{\\left(6x+1\\right)\\cdot\\left(23\\sqrt{x}+4\\right)}{\\left(e^{9x}+\\sqrt{6e^{2x}}+3x\\right)\\left(23\\sqrt{x}+4\\right)}+\\frac{\\left(49x^{2}+6\\right)\\cdot\\left(e^{9x}+\\sqrt{6e^{2x}}+3x\\right)}{\\left(e^{9x}+\\sqrt{6e^{2x}}+3x\\right)\\left(23\\sqrt{x}+4\\right)}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Apply The Fraction Rule:}\\ \\frac{a}{c}\\pm\\frac{b}{c}=\\frac{a \\pm b}{c}', 'info': '\\displaystyle \\frac{\\left(6x+1\\right)\\cdot\\left(23\\sqrt{x}+4\\right)}{\\left(e^{9x}+\\sqrt{6e^{2x}}+3x\\right)\\left(23\\sqrt{x}+4\\right)}+\\frac{\\left(49x^{2}+6\\right)\\cdot\\left(e^{9x}+\\sqrt{6e^{2x}}+3x\\right)}{\\left(e^{9x}+\\sqrt{6e^{2x}}+3x\\right)\\left(23\\sqrt{x}+4\\right)}=\\frac{\\left(6x+1\\right)\\cdot\\left(23\\sqrt{x}+4\\right)+\\left(49x^{2}+6\\right)\\cdot\\left(e^{9x}+\\sqrt{6e^{2x}}+3x\\right)}{\\left(e^{9x}+\\sqrt{6e^{2x}}+3x\\right)\\left(23\\sqrt{x}+4\\right)}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Combine Results}', 'info': '\\displaystyle \\frac{\\left(6x+1\\right)\\cdot\\left(23\\sqrt{x}+4\\right)+\\left(49x^{2}+6\\right)\\cdot\\left(e^{9x}+\\sqrt{6e^{2x}}+3x\\right)}{\\left(e^{9x}+\\sqrt{6e^{2x}}+3x\\right)\\left(23\\sqrt{x}+4\\right)}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Apply FOIL Method}: \\\\ (a+b)(c+d)=ac+ad+bc+bd', 'info': '\\displaystyle \\left(6x+1\\right)\\left(23\\sqrt{x}+4\\right)=6x\\cdot23\\sqrt{x}+6x\\cdot4+1\\cdot23\\sqrt{x}+1\\cdot4'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle 6x\\cdot4=24x'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle 1\\cdot23\\sqrt{x}=23\\sqrt{x}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle 1\\cdot4=4'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Group Terms}', 'info': '\\displaystyle \\displaystyle 6x\\cdot23\\sqrt{x}+24x+23\\sqrt{x}+4=6x\\cdot23\\sqrt{x}+23\\sqrt{x}+24x+4'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Combine Results}', 'info': '\\displaystyle 6x\\cdot23\\sqrt{x}+6x\\cdot4+1\\cdot23\\sqrt{x}+1\\cdot4=6x\\cdot23\\sqrt{x}+23\\sqrt{x}+24x+4'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Distribute Parentheses}', 'info': '\\displaystyle \\left(49x^{2}+6\\right)\\left(e^{9x}+\\sqrt{6e^{2x}}+3x\\right)=49x^{2}\\cdot e^{9x}+49x^{2}\\cdot\\sqrt{6e^{2x}}+49x^{2}\\cdot3x+6\\cdot e^{9x}+6\\cdot\\sqrt{6e^{2x}}+6\\cdot3x'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle 49x^{2}\\cdot e^{9x}=49x^{2}e^{9x}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle 49x^{2}\\cdot\\sqrt{6e^{2x}}=49x^{2}\\sqrt{6e^{2x}}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle 49x^{2}\\cdot3x=147x^{2+1}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle 6\\cdot e^{9x}=6e^{9x}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle 6\\cdot\\sqrt{6e^{2x}}=6\\sqrt{6e^{2x}}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle 6\\cdot3x=18x'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Group Terms}', 'info': '\\displaystyle \\displaystyle 49x^{2}e^{9x}+49x^{2}\\sqrt{6e^{2x}}+147x^{2+1}+6e^{9x}+6\\sqrt{6e^{2x}}+18x=147x^{2+1}+6e^{9x}+6\\sqrt{6e^{2x}}+49x^{2}e^{9x}+49x^{2}\\sqrt{6e^{2x}}+18x'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Add Numbers Left to Right}', 'info': '\\displaystyle 2+1=3'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Simplify Exponent}', 'info': '\\displaystyle 147x^{2+1}=147x^{3}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Combine Exponentials}', 'info': '\\displaystyle 147x^{2+1}+6e^{9x}=147x^{3}+6e^{9x}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Combine Results}', 'info': '\\displaystyle 49x^{2}\\cdot e^{9x}+49x^{2}\\cdot\\sqrt{6e^{2x}}+49x^{2}\\cdot3x+6\\cdot e^{9x}+6\\cdot\\sqrt{6e^{2x}}+6\\cdot3x=147x^{3}+6e^{9x}+6\\sqrt{6e^{2x}}+49x^{2}e^{9x}+49x^{2}\\sqrt{6e^{2x}}+18x'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Group Terms}', 'info': '\\displaystyle \\displaystyle 6x\\cdot23\\sqrt{x}+23\\sqrt{x}+24x+4+147x^{3}+6e^{9x}+6\\sqrt{6e^{2x}}+49x^{2}e^{9x}+49x^{2}\\sqrt{6e^{2x}}+18x=147x^{3}+6e^{9x}+6x\\cdot23\\sqrt{x}+23\\sqrt{x}+6\\sqrt{6e^{2x}}+24x+4+49x^{2}e^{9x}+49x^{2}\\sqrt{6e^{2x}}+18x'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Group Like Terms}', 'info': '\\displaystyle 24x+4+49x^{2}e^{9x}+49x^{2}\\sqrt{6e^{2x}}+18x=24x+18x+49x^{2}e^{9x}+49x^{2}\\sqrt{6e^{2x}}+4'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Add Like Terms Left to Right}', 'info': '\\displaystyle 24x+18x+49x^{2}e^{9x}+49x^{2}\\sqrt{6e^{2x}}+4=42x+49x^{2}e^{9x}+49x^{2}\\sqrt{6e^{2x}}+4'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Simplify Numerator}', 'info': '\\displaystyle \\frac{\\left(6x+1\\right)\\cdot\\left(23\\sqrt{x}+4\\right)+\\left(49x^{2}+6\\right)\\cdot\\left(e^{9x}+\\sqrt{6e^{2x}}+3x\\right)}{\\left(e^{9x}+\\sqrt{6e^{2x}}+3x\\right)\\left(23\\sqrt{x}+4\\right)}=\\frac{147x^{3}+6e^{9x}+6x\\cdot23\\sqrt{x}+23\\sqrt{x}+6\\sqrt{6e^{2x}}+42x+49x^{2}e^{9x}+49x^{2}\\sqrt{6e^{2x}}+4}{\\left(e^{9x}+\\sqrt{6e^{2x}}+3x\\right)\\left(23\\sqrt{x}+4\\right)}'}], 'finalResult': '\\frac{147x^{3}+6e^{9x}+6x\\cdot23\\sqrt{x}+23\\sqrt{x}+6\\sqrt{6e^{2x}}+42x+49x^{2}e^{9x}+49x^{2}\\sqrt{6e^{2x}}+4}{\\left(e^{9x}+\\sqrt{6e^{2x}}+3x\\right)\\left(23\\sqrt{x}+4\\right)}'},
            },
            {
            ...
            },
            {
                ...
                'expected_val': {'steps': [
                    ...
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Adjust fractions based on their LCM of }v', 'info': '\\displaystyle \\frac{\\sqrt{v^{2}+1}}{v}+\\frac{1}{v}+\\frac{v}{1}=\\frac{\\sqrt{v^{2}+1}}{v}+\\frac{1}{v}+\\frac{v\\cdot v}{v}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Apply The Fraction Rule:}\\ \\frac{a}{c}\\pm\\frac{b}{c}=\\frac{a \\pm b}{c}', 'info': '\\displaystyle \\frac{\\sqrt{v^{2}+1}}{v}+\\frac{1}{v}+\\frac{v\\cdot v}{v}=\\frac{\\sqrt{v^{2}+1}+v\\cdot v+1}{v}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Combine Results}', 'info': '\\displaystyle \\frac{\\sqrt{v^{2}+1}+v\\cdot v+1}{v}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle v\\cdot v=v^{1+1}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Group Terms}', 'info': '\\displaystyle \\displaystyle \\sqrt{v^{2}+1}+v^{1+1}+1=v^{1+1}+\\sqrt{v^{2}+1}+1'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Add Numbers Left to Right}', 'info': '\\displaystyle 1+1=2'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Simplify Exponent}', 'info': '\\displaystyle v^{1+1}=v^{2}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Simplify Numerator}', 'info': '\\displaystyle \\frac{\\sqrt{v^{2}+1}+v\\cdot v+1}{v}=\\frac{v^{2}+\\sqrt{v^{2}+1}+1}{v}'}], 'finalResult': '\\frac{v^{2}+\\sqrt{v^{2}+1}+1}{v}'},
            },
            {
                ...
                'expected_val': {'steps': [
                    ...
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Adjust fractions based on their LCM of }\\sqrt{u^{2}+1}', 'info': '\\displaystyle \\frac{1}{\\sqrt{u^{2}+1}}+\\frac{u}{1}=\\frac{1}{\\sqrt{u^{2}+1}}+\\frac{u\\cdot\\sqrt{u^{2}+1}}{\\sqrt{u^{2}+1}}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Apply The Fraction Rule:}\\ \\frac{a}{c}\\pm\\frac{b}{c}=\\frac{a \\pm b}{c}', 'info': '\\displaystyle \\frac{1}{\\sqrt{u^{2}+1}}+\\frac{u\\cdot\\sqrt{u^{2}+1}}{\\sqrt{u^{2}+1}}=\\frac{u\\cdot\\sqrt{u^{2}+1}+1}{\\sqrt{u^{2}+1}}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Combine Results}', 'info': '\\displaystyle \\frac{u\\cdot\\sqrt{u^{2}+1}+1}{\\sqrt{u^{2}+1}}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle u\\cdot\\sqrt{u^{2}+1}=u\\sqrt{u^{2}+1}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Simplify Numerator}', 'info': '\\displaystyle \\frac{u\\cdot\\sqrt{u^{2}+1}+1}{\\sqrt{u^{2}+1}}=\\frac{u\\sqrt{u^{2}+1}+1}{\\sqrt{u^{2}+1}}'}], 'finalResult': '\\frac{u\\sqrt{u^{2}+1}+1}{\\sqrt{u^{2}+1}}'},
            },
            {
                ...
                'expected_val': {'steps': [
                    ...
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Adjust fractions based on their LCM of }e^{6}', 'info': '\\displaystyle 3-\\frac{1}{e^{6}}+1=\\frac{3\\cdot e^{6}}{e^{6}}-\\frac{1}{e^{6}}+\\frac{e^{6}}{e^{6}}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Apply The Fraction Rule:}\\ \\frac{a}{c}\\pm\\frac{b}{c}=\\frac{a \\pm b}{c}', 'info': '\\displaystyle \\frac{3\\cdot e^{6}}{e^{6}}-\\frac{1}{e^{6}}+\\frac{e^{6}}{e^{6}}=\\frac{3\\cdot e^{6}+e^{6}-1}{e^{6}}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Combine Results}', 'info': '\\displaystyle \\frac{3\\cdot e^{6}+e^{6}-1}{e^{6}}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle 3\\cdot e^{6}=3e^{6}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Add Like Exponentials}', 'info': '\\displaystyle 3e^{6}+e^{6}=4e^{6}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Simplify Numerator}', 'info': '\\displaystyle \\frac{3\\cdot e^{6}+e^{6}-1}{e^{6}}=\\frac{4e^{6}-1}{e^{6}}'}], 'finalResult': '\\frac{4e^{6}-1}{e^{6}}'},
            },
            {
                'expression': 'frac{2+x}{x+y}+frac{3x+1}{1+x}',
                'keyword': 'combine',
                'expected_val': {'steps': [
                    {'type': 'e-step', 'heading': '\\displaystyle \\frac{2+x}{x+y}=\\frac{x+2}{x+y}', 'e-steps': [
                        {'type': 'main-step', 'description': '\\displaystyle \\text{Group Like Terms}', 'info': '\\displaystyle 2+x=x+2'},
                        {'type': 'main-step', 'description': '\\displaystyle \\text{Simplify Numerator}', 'info': '\\displaystyle \\frac{2+x}{x+y}=\\frac{x+2}{x+y}'}]},
                    {'type': 'e-step', 'heading': '\\displaystyle \\frac{3x+1}{1+x}=\\frac{3x+1}{x+1}', 'e-steps': [
                        {'type': 'main-step', 'description': '\\displaystyle \\text{Group Like Terms}', 'info': '\\displaystyle 1+x=x+1'},
                        {'type': 'main-step', 'description': '\\displaystyle \\text{Simplify Denominator}', 'info': '\\displaystyle \\frac{3x+1}{1+x}=\\frac{3x+1}{x+1}'}]},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Adjust fractions based on their LCM of }\\left(x+y\\right)\\left(x+1\\right)', 'info': '\\displaystyle \\frac{x+2}{x+y}+\\frac{3x+1}{x+1}=\\frac{\\left(x+2\\right)\\cdot\\left(x+1\\right)}{\\left(x+y\\right)\\left(x+1\\right)}+\\frac{\\left(3x+1\\right)\\cdot\\left(x+y\\right)}{\\left(x+y\\right)\\left(x+1\\right)}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Apply The Fraction Rule:}\\ \\frac{a}{c}\\pm\\frac{b}{c}=\\frac{a \\pm b}{c}', 'info': '\\displaystyle \\frac{\\left(x+2\\right)\\cdot\\left(x+1\\right)}{\\left(x+y\\right)\\left(x+1\\right)}+\\frac{\\left(3x+1\\right)\\cdot\\left(x+y\\right)}{\\left(x+y\\right)\\left(x+1\\right)}=\\frac{\\left(x+2\\right)\\cdot\\left(x+1\\right)+\\left(3x+1\\right)\\cdot\\left(x+y\\right)}{\\left(x+y\\right)\\left(x+1\\right)}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Combine Results}', 'info': '\\displaystyle \\frac{\\left(x+2\\right)\\cdot\\left(x+1\\right)+\\left(3x+1\\right)\\cdot\\left(x+y\\right)}{\\left(x+y\\right)\\left(x+1\\right)}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Apply FOIL Method}: \\\\ (a+b)(c+d)=ac+ad+bc+bd', 'info': '\\displaystyle \\left(x+2\\right)\\left(x+1\\right)=x\\cdot x+x\\cdot1+2\\cdot x+2\\cdot1'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle x\\cdot x=x^{1+1}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle x\\cdot1=x'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle 2\\cdot x=2x'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle 2\\cdot1=2'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Add Numbers Left to Right}', 'info': '\\displaystyle 1+1=2'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Simplify Exponent}', 'info': '\\displaystyle x^{1+1}=x^{2}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Add Like Terms Left to Right}', 'info': '\\displaystyle x+2x+2=3x+2'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Combine Results}', 'info': '\\displaystyle x\\cdot x+x\\cdot1+2\\cdot x+2\\cdot1=x^{2}+3x+2'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Apply FOIL Method}: \\\\ (a+b)(c+d)=ac+ad+bc+bd', 'info': '\\displaystyle \\left(3x+1\\right)\\left(x+y\\right)=3x\\cdot x+3x\\cdot y+1\\cdot x+1\\cdot y'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle 3x\\cdot x=3x^{1+1}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle 3x\\cdot y=3xy'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle 1\\cdot x=1x'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle 1\\cdot y=1y'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Add Numbers Left to Right}', 'info': '\\displaystyle 1+1=2'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Simplify Exponent}', 'info': '\\displaystyle 3x^{1+1}=3x^{2}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Add Like Terms Left to Right}', 'info': '\\displaystyle 3xy+1x+1y=3xy+x+y'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Combine Results}', 'info': '\\displaystyle 3x\\cdot x+3x\\cdot y+1\\cdot x+1\\cdot y=3x^{2}+3xy+x+y'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Group Terms}', 'info': '\\displaystyle \\displaystyle x^{2}+3x+2+3x^{2}+3xy+x+y=x^{2}+3x^{2}+3x+2+3xy+x+y'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Add Like Exponentials}', 'info': '\\displaystyle x^{2}+3x^{2}=4x^{2}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Group Like Terms}', 'info': '\\displaystyle 3x+2+3xy+x+y=3x+x+3xy+y+2'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Add Like Terms Left to Right}', 'info': '\\displaystyle 3x+x+3xy+y+2=4x+3xy+y+2'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Simplify Numerator}', 'info': '\\displaystyle \\frac{\\left(x+2\\right)\\cdot\\left(x+1\\right)+\\left(3x+1\\right)\\cdot\\left(x+y\\right)}{\\left(x+y\\right)\\left(x+1\\right)}=\\frac{4x^{2}+4x+3xy+y+2}{\\left(x+y\\right)\\left(x+1\\right)}'}], 'finalResult': '\\frac{4x^{2}+4x+3xy+y+2}{\\left(x+y\\right)\\left(x+1\\right)}'}
            }
        ...
        expressionsAndExpectedVal = [
            ...
            },
            {
                ...
                'expected_val': {'steps': [
                    ...
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Adjust fractions based on their LCM of }2x^{3}', 'info': '\\displaystyle \\frac{3\\sqrt{x^{4}+1}}{2x^{3}}+\\frac{c}{x^{3}}=\\frac{3\\sqrt{x^{4}+1}}{2x^{3}}+\\frac{c\\cdot2}{2x^{3}}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Apply The Fraction Rule:}\\ \\frac{a}{c}\\pm\\frac{b}{c}=\\frac{a \\pm b}{c}', 'info': '\\displaystyle \\frac{3\\sqrt{x^{4}+1}}{2x^{3}}+\\frac{c\\cdot2}{2x^{3}}=\\frac{3\\sqrt{x^{4}+1}+c\\cdot2}{2x^{3}}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Combine Results}', 'info': '\\displaystyle \\frac{3\\sqrt{x^{4}+1}+c\\cdot2}{2x^{3}}'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Multiply And Divide (left to right)}', 'info': '\\displaystyle c\\cdot2=2c'},
                    {'type': 'main-step', 'description': '\\displaystyle \\text{Simplify Numerator}', 'info': '\\displaystyle \\frac{3\\sqrt{x^{4}+1}+c\\cdot2}{2x^{3}}=\\frac{3\\sqrt{x^{4}+1}+2c}{2x^{3}}'}], 'finalResult': '\\frac{3\\sqrt{x^{4}+1}+2c}{2x^{3}}'},
            },
            {
